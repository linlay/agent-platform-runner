...
ensure_dir "${PROVIDERS_DIR:-$SCRIPT_DIR/runtime/registries/providers}"
ensure_dir "${MODELS_DIR:-$SCRIPT_DIR/runtime/registries/models}"
ensure_dir "${MCP_SERVERS_DIR:-$SCRIPT_DIR/runtime/registries/mcp-servers}"
ensure_dir "${VIEWPORT_SERVERS_DIR:-$SCRIPT_DIR/runtime/registries/viewport-servers}"
