...
public final class PlanExecuteMode extends AgentMode {
    ...
    private boolean isUpdateToolCall(com.linlay.agentplatform.engine.runtime.PlannedToolCall call, String taskId) {
    ...
    private boolean containsPlanAddCall(List<com.linlay.agentplatform.engine.runtime.PlannedToolCall> calls) {
