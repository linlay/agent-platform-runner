...
import com.linlay.agentplatform.engine.runtime.PlannedToolCall;
...
import com.linlay.agentplatform.engine.runtime.PlanTaskDeltaBuilder;
import com.linlay.agentplatform.engine.exception.RunInterruptedException;
import com.linlay.agentplatform.engine.runtime.ExecutionContext;
import com.linlay.agentplatform.engine.runtime.RunLoopState;
...
public class ToolExecutionService {
    ...
    public List<com.linlay.agentplatform.llm.LlmService.LlmFunctionTool> enabledFunctionTools(Map<String, BaseTool> enabledToolsByName) {
        ...
        return enabledToolsByName.values().stream()
                ...
                .map(tool -> new com.linlay.agentplatform.llm.LlmService.LlmFunctionTool(
